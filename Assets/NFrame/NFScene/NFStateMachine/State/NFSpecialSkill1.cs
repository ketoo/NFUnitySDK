...
public class NFSpecialSkill1 : NFIState
{
    ...
    public NFSpecialSkill1(GameObject gameObject, NFAnimaStateType eState, NFAnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
    ...
    public override void Enter(GameObject gameObject, int index)
    {
        ...
        //mAnimatStateController.PlayAnimaState(NFAnimaStateType.SpecialSkill1);
    }
