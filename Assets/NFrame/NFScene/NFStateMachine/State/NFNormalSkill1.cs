...
public class NFNormalSkill1 : NFIState
{
    ...
    public NFNormalSkill1(GameObject gameObject, NFAnimaStateType eState, NFAnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
