...
public class NFNormalSkill2 : NFIState
{
    ...
    public NFNormalSkill2(GameObject gameObject, NFAnimaStateType eState, NFAnimaStateMachine xStateMachine, float fHeartBeatTime, float fExitTime, bool input = false)
    ...
    public override void Enter(GameObject gameObject, int index)
    {
        ...
        //mAnimatStateController.PlayAnimaState(NFAnimaStateType.NormalSkill2);
    }
