...
// -------------------------------------------------------------------------
	...
	{
		//Class name
		public static  ThisName = "CooldownRecord";
		// IObject
	...
	class Item
	{
		...
		public static AwardProperty = "AwardProperty";// int
...
export const NFConfig={
		CooldownRecord,EffectData,GM,Group,IObject,InitProperty,Item,Language,NPC,NoSqlServer,Player,Scene,Security,Server,Skill}
